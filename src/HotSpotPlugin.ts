...
export class Hotspot {
     ...
     */
    isAvailable(callback:Function):void {
     ...
     */
    getWriteSettings(successCB:Function, errorCB:Function):void {
        cordova.exec(
            function (val) {
                if (val === 1)
                    successCB(true);
     ...
     */
    requestWriteSettings(requestWriteSettingsCallback:Function, errorCB:Function):void {
        cordova.exec(
            successCB,
            errorCB,
            'HotSpotPlugin',
     ...
     *      A callback function to be called when errors occurr
     */
    toggleWifi(callback:Function, errorCB:Function):void {
...
,
    ...
    function (ssid, mode, password, successCB, errorCB) {
...
,
    ...
    function (successCB, errorCallback) {
...
,
    ...
    function (ssid, password, successCB, errorCB) {
        cordova.exec(successCB, function (err) {
            errorCB(err);
...
,
    ...
    function (ssid, password, authentication, encryption, successCB, errorCB) {
        cordova.exec(successCB, function (err) {
            errorCB(err);
...
,
    ...
    function (ssid, successCB, errorCB) {
        cordova.exec(successCB, function (err) {
            errorCB(err);
...
,
    ...
    function (interval, duration, successCB, errorCB) {
        cordova.exec(successCB, function (err) {
            errorCB(err);
...
,
     ...
     *      An error callback
     */
    pingHost(ip:string, successCB:Function, errorCB:Function) :void{
     ...
     *      An error callback
     */
    getMacAddressOfHost (ip:string, successCB:Function, errorCB:Function):void {
        cordova.exec(successCB, function (err) {
            errorCB(err);
     ...
     *      An error callback
     */
    isDnsLive(ip:string, successCB:Function, errorCB:Function):void {
        cordova.exec(function (code) {
            if (code === 1) {
                successCB(true);
            } else {
     ...
     *      An error callback
     */
    isPortLive(ip:string, successCB:Function, errorCB:Function):void {
        cordova.exec(function (code) {
            if (code === 1) {
                successCB(true);
            } else {
     ...
     *      An error callback
     */
    isRooted(successCB:Function, errorCB:Function):void {
        cordova.exec(function (code) {
            if (code === 1) {
                successCB(true);
            } else {
